...
const DEFAULT_TOOL_CATALOGS: readonly CapabilityCatalogConfig[] = [
  ...
  createCapabilityConfig('default-tool-search', 'search', 'Search', 'Search workspace, repository, or indexed context during execution.'),
  createCapabilityConfig('default-tool-get-ticket-summary', 'get_ticket_summary', 'Get Ticket Summary', 'Load a lightweight summary for the active or related ticket.'),
  createCapabilityConfig('default-tool-get-parent-chain', 'get_parent_chain', 'Get Parent Chain', 'Inspect parent ticket lineage before planning or delivery.'),
  createCapabilityConfig('default-tool-list-sibling-results', 'list_sibling_results', 'List Sibling Results', 'Review adjacent ticket outputs before making downstream decisions.'),
  createCapabilityConfig('default-tool-list-ticket-artifacts', 'list_ticket_artifacts', 'List Ticket Artifacts', 'Inspect deliverables and handoff manifests already attached to a ticket.'),
  createCapabilityConfig('default-tool-list-tickets', 'list_tickets', 'List Tickets', 'List accessible tickets for broader planning or review context.'),
  createCapabilityConfig('default-tool-get-ticket-context', 'get_ticket_context', 'Get Ticket Context', 'Load the full ticket ancestry and execution context when lightweight tools are insufficient.'),
  createCapabilityConfig('default-tool-list-workspace-dirs', 'list_workspace_dirs', 'List Workspace Dirs', 'List available workspace directories before reading or writing artifacts.'),
  createCapabilityConfig('default-tool-read-workspace-dir', 'read_workspace_dir', 'Read Workspace Dir', 'Inspect directory contents and artifact layout within the workspace.'),
  createCapabilityConfig('default-tool-file-operation', 'file_operation', 'File Operation', 'Perform common file reads, writes, listings, and artifact management tasks from one tool surface.'),
  ...
  createCapabilityConfig('default-tool-write-file', 'write_file', 'Write File', 'Create or overwrite files as part of implementation delivery.'),
  createCapabilityConfig('default-tool-edit-file', 'edit_file', 'Edit File', 'Modify source files as part of implementation delivery.'),
  createCapabilityConfig('default-tool-browser', 'browser', 'Browser', 'Open pages, inspect the DOM, and interact with browser UI during runtime work.'),
  createCapabilityConfig('default-tool-fetch', 'fetch', 'Fetch', 'Call HTTP endpoints and retrieve structured responses from internal or external services.'),
  ...
  createCapabilityConfig('default-tool-spawn-child-tickets', 'spawn_child_tickets', 'Spawn Child Tickets', 'Create child tickets for delegated execution or parallel research.'),
  createCapabilityConfig('default-tool-merge-child-results', 'merge_child_results', 'Merge Child Results', 'Merge child ticket outputs back into the active planning or review flow.'),
...
export const TOOL_CATALOG_INCREMENTAL_DEFAULT_KEYS = [
  'search',
  'get_ticket_summary',
  'get_parent_chain',
  'list_sibling_results',
...
export const DEFAULT_CAPABILITY_CATALOGS: Record<CapabilityCatalogKind, readonly CapabilityCatalogConfig[]> = {
  ...
  [CAPABILITY_CATALOG_KIND.Tools]: DEFAULT_TOOL_CATALOGS,

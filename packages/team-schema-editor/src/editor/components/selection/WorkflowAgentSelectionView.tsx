...
type WorkflowAgentSelectionViewProps = {
...
export const WorkflowAgentSelectionView = ({
  schema,
  workflowNode,
...
}: WorkflowAgentSelectionViewProps): ReactElement => {
  ...
  return (
    <Stack spacing={2}>
      ...
      <TextField
        ...
        value={workflowNode.data.workflowMetadata?.description ?? ''}

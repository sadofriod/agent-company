...
export const DepartmentNode = ({ data, selected }: NodeProps<WorkflowGraphNode>): ReactElement => {
	...
	return (
		<NodeShell eyebrow="Department" title={data.nodeName} accent={data.accent} selected={selected} runtimeHighlighted={data.runtimeHighlighted} runtimeDimmed={data.runtimeDimmed} workflowNodeType={data.workflowNodeType}>
			<Stack spacing={0.75}>

...
export const DiscussionMemoryNode = ({ data, selected }: NodeProps<WorkflowGraphNode>): ReactElement => {
	...
	return (
		<NodeShell eyebrow="Discussion Memory" title={data.nodeName} accent={data.accent} selected={selected} runtimeHighlighted={data.runtimeHighlighted} runtimeDimmed={data.runtimeDimmed} variant={NodeShellVariant.Memory} workflowNodeType={data.workflowNodeType}>
			<Stack spacing={0.75}>
